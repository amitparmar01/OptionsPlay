...
{
    /// <summary>
    /// Defines section 'marketDataConfigurationBak' in web.config
    /// </summary>
    public class SZKingdomConfigurationBak : ConfigurationSection
    {
        private SZKingdomConfigurationBak()
        {
        }

        public static SZKingdomConfigurationBak LoadConfiguration()
        {
            SZKingdomConfigurationBak configuration = (SZKingdomConfigurationBak)ConfigurationManager.GetSection("SZKingdomConfigurationBak");
